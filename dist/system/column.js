...
System.register(['aurelia-dependency-injection', 'aurelia-templating'], function (_export, _context) {
  var inject, bindable, customElement, noView, processContent, ViewCompiler, _dec, _dec2, _dec3, _class, _desc, _value, _class2, _descriptor, Column;
  ...
  return {
    ...
    execute: function () {
      _export('Column', Column = (_dec = processContent(false), _dec2 = customElement('au-column'), _dec3 = inject(Element, ViewCompiler), noView(_class = _dec(_class = _dec2(_class = _dec3(_class = (_class2 = function Column(element, viewCompiler) {
